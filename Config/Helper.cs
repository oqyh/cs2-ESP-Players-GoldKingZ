...
public class Helper
{
    ...
    public static void SetGlowPlayer(CCSPlayerController Getplayer)
    {
        ...
        var player = Getplayer.CheckPlayerController();
        if(player == null 
    ...
    {
        foreach(var players in GetPlayersController(true,false,false,false,true,true))
        {
    ...
    {
        foreach (var players in GetPlayersController(true,true,false,true,true,true))
        {
            if(players == null || !players.IsValid) continue;
