...
namespace ESP_Players_GoldKingZ.Config
{
    ...
    public class Toggle_ESP
    {
        ...
        [Comment("\"SteamIDs:  | Flags:  | Groups: \" = To Allow Everyone")]
        [String("SteamIDs", "Flags", "Groups")]
        public string Toggle_ESP_Flags { get; set; } = "SteamIDs: 76561198206086993,76561198974936845 | Flag: @css/vips,@css/admins | Group: #css/vips,#css/admins";
        ...
        [Comment("2 = Yes, Hide All The Time")]
        [Range(0, 2, 0,
        "Toggle_ESP_Hide: is invalid, setting to default value (0) Please Choose From 0 To 2." +
        "0 = No\n" +
        "1 = Yes, But Only After Toggle Successfully\n" +
        "2 = Yes, Hide All The Time")]
    ...
    public class Config
    {
        ...
        public bool DefaultToggleGlow { get; set; } = false;
        ...
        [Range(0, 2, 0,
        "Show_ESP_For: is invalid, setting to default value (0) Please Choose From 0 To 2.\n" +
        "0 = Any\n" +
        "1 = Dead Players\n" +
        "2 = Spec Players")]
